...
export function Carousel_container() {
  return (
    <div className="container mt-0" style={{ width: "60%", height: "60%" }}>
      <Carousel_1 />
    </div>
  );
}
  ...
  return (
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-3" style={{ width: "30%", height: "30%" }}>
...
function Middle_2_house() {
  return <img src={house} className="d-block w-100 " />;
}
...
function Middle_2_tooltip(props) {
  ...
  return (
    <div>
      <a className="link" onMouseEnter={props.handle_mouse_enter}>
        <img
          src={circle}
          style={{
            width: "3%",
  ...
  return (
    <div className="container">
      <div className="row " style={{ marginLeft: "10%" }}>
        <div className="col-xm-12 col-sm-6 col-md-4 position-relative">
          <Middle_3_image_text
            header={"This is header"}
            content={"This is contenet,This is contenet,This is contenet"}
            src={mid_2}
          />
        </div>
        <div className="col-xm-12 col-sm-6 col-md-4 position-relative">
...
export function Middle_3_image_text(props) {
  return (
    <div>
      ...
      <Middle_3_text header={props.header} content={props.content} />
    </div>
  );
}
...
function Middle_3_text(props) {
  return (
    ...
    >
      <h3 style={{ color: "orange" }}>{props.header}</h3>
      <p>{props.content}</p>
    </div>
  );
}
